...
class Detector(object):
    ...
    def __init__(self, cmds):
        ...
        self.chips  = [Chip(self.layout["x_cen"][i], self.layout["y_cen"][i], 
                            ...
                            self.layout["pix_res"][i]) 
                            for i in range(len(self.layout["chip"]))]
...
class Chip(object):
    ...
    def __init__(self, x_cen, y_cen, x_len, y_len, pix_res):
        """
        Parameters
        ==========
        x_cen, y_cen : float
    ...
    def read_out(self, cmds):
        ...
        out_array += self._read_noise_frame(cmds)
    ...
    def _read_noise_frame(self, cmds):
        ...
        if cmds["FPA_NOISE_PATH"] is not None:
            ...
            return fits.getdata(cmds["FPA_NOISE_PATH"], layer)
        else:
            if cmds["HXRG_OUTPUT_PATH"] is not None:
                self._generate_hxrg_noise(cmds)
                return fits.getdata(cmds["HXRG_OUTPUT_PATH"])
            else:
