...
`SCOPE_PSF_FILE = data/PSF_LTAO.fits`          Source: ESO E-ELT optics webpage (2012 study), updated on 02.11.2016

![./images/PSF_LTAO.fits.png](./images/PSF_LTAO.fits.png) 
...
`INST_FILTER_TC = data/TC_filter_Ks.dat`          Source: ESO E-ELT technical database, updated on 02.11.2016
